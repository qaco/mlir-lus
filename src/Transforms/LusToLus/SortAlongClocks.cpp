#include "SortAlongClocks.h"
#include "../../Dialects/Lus/ClockAnalysis.h"

namespace mlir {
  namespace lus {

    void SortAlongClocks::operator() (NodeOp nodeOp) {
    ...
    bool SortAlongClocks::dominanceCorrection(Operation* op) {
    ...
    bool SortAlongClocks::nextOnSameClock() {
    ...
    bool SortAlongClocks::nextOnSubClock() {
      Operation *lastOp = orderedOps.back();
      list<Operation*>::iterator it;
      it = unorderedOps.begin();
      while (it != unorderedOps.end()) {
    ...
    bool SortAlongClocks::nextOnTiniestClock() {
      Operation *tiniest;
      int tiniestSize;
      bool zeroFound = true;
      unsigned i = 0;
