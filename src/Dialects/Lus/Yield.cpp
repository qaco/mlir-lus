...
namespace mlir {
  namespace lus {
    ...
    LogicalResult YieldOp::verify() {
	 ...
	 isa<OnClockOp>(getOperation()->getParentOp()) ||
	 isa<NodeTestOp>(getOperation()->getParentOp())) {
	return success();
      }
      return emitOpError() << getOperationName()
			   << " op expects parent op lus node";
    }
    ...
    ArrayRef<StringRef> YieldOp::getAttributeNames() {
